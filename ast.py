                        ...
                        defns=[
                            ErrorDefn(
                                ...
                                defn=EnumVariantStruct(
                                    name=Ident(
                                        symbol=Token("__ANON_17", "ImproperFormat")
                                    ),
                                    members=[
                                        TypeAssign(
                                            annotations=None,
                        ...
                        defns=[
                            [
                                ErrorDefn(
                                    ...
                                    defn=EnumVariantStruct(
                                        name=Ident(
                                            symbol=Token("__ANON_17", "NotEnabled")
                                        ),
                                        members=[
                                            TypeAssign(
                                                annotations=None,
                                ...
                                ErrorDefn(
                                    ...
                                    defn=EnumVariantUnit(
                                        name=Ident(
                                            symbol=Token("__ANON_17", "Unauthorized")
                                        )
                                    ),
                                ),
                                ErrorDefn(
                                    ...
                                    defn=EnumVariantStruct(
                                        ...
                                        members=[
                                            TypeAssign(
                                                annotations=None,
                                                name=Ident(
                                                    symbol=Token("__ANON_16", "balance")
                                                ),
                                                type=Typename(
                                                    name=Ident(
                                                        symbol=Token(
                            ...
                            type=StructCDefn(
                                ...
                                members=[
                                    ...
                                    TypeAssign(
                                        ...
                                        type=Typename(
                                            name=Ident(
                                                symbol=Token("__ANON_16", "Decimal")
                                            )
                                        ),
                                    ),
                                ],
                        ...
                        defn=InstantiateDefn(
                            ...
                            body=[
                                AssignStmt(
                                    ...
                                    rhs=StructVal(
                                        name=Ident(
                                            symbol=Token("__ANON_17", "ConfigData")
                                        ),
                                        members=[
                                            StructValAssign(
                                                name=Ident(
                        ...
                        defns=[
                            QueryDefnFn(
                                ...
                                response_type=StructCDefn(
                                    annotations=None,
                                    name=Ident(
                                        symbol=Token("__ANON_17", "CountResponse")
                                    ),
                                    members=[
                                        TypeAssign(
                                            annotations=None,
                                ...
                                response_defn=[
                                    ...
                                    TypeAssignAndSet(
                                        type_assign=TypeAssign(
                                            ...
                                            type=Typename(
                                                name=Ident(
                                                    symbol=Token("__ANON_16", "Uint128")
                                                )
                                            ),
                                        ),
                        ...
                        defns=[
                            QueryDefnFn(
                                ...
                                response_type=StructCDefn(
                                    ...
                                    name=Ident(
                                        symbol=Token(
                                            "__ANON_17", "UserBalanceForTokenResponse"
                                        )
                                    ),
                                    members=[
                                        TypeAssign(
